...
In this course, we will be learning the basics of programming using `Java` language. There would be 1 lab for each chapters in this course, and each lab would have questions for students to try and solve using their coding skills.
